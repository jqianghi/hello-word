...
<div class="w" id="logo">
    <div>
    	<a href="http://localhost:8082">
    		<img src="/images/sypro.png" alt="宜立方商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <div class="extra">
        <span>我已经注册，现在就&nbsp;
        	<a href="/sso/showLogin" class="flk13">登录</a>
        </span>
        </div>
    </div>
    <div class="mc">
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《宜立方用户注册协议》</a></label>
                        <span class="clr"></span>
...
<script type="text/javascript">
	var REGISTER={
		...
		doSubmit:function() {
			$.post("/sso/register",$("#personRegForm").serialize(), function(data){
				if(data.status == 200){
					alert('用户注册成功，请登录！');
					REGISTER.login();
				} else {
